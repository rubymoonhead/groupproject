<?php
  if (isset($_SESSION['artistuser_id'])) { // session security
    ...
    echo "<head>
      ...
      <main id='showcase_single'>";

          $artistprofile_id = $_SESSION['artistuser_id'];
          //this query shows single artistprofile_id
          $query = "SELECT * FROM ARTISTPROFILE WHERE artistprofile_id = $artistprofile_id";

          $result = mysqli_query($connection, $query);

      //Fetch and print all records

      // Create template literal that displays single artistprofile_id data
